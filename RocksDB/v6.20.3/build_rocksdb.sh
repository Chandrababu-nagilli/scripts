...
function configureAndInstall() {
        ...
        if [[ "$JAVA_PROVIDED" == "SemuruJDK8" ]]; then
                ...
                curl -SL -o semurujdk.tar.gz https://github.com/ibmruntimes/semeru8-binaries/releases/download/jdk8u302-b08_openj9-0.27.0/ibm-semeru-open-jdk_s390x_linux_8u302b08_openj9-0.27.0.tar.gz
...
function gettingStarted() {
        ...
        printf -- "Note: To set the Environment Variables needed for rocksdb, please run: source $HOME/setenv.sh \n\n"
